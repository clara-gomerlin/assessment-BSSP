        ...
        <div className="rei-hero-preview" style={{ display: "flex", flexDirection: "column", gap: 16, animation: "fadeSlideUp 0.6s ease-out 0.3s both" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 12, padding: "4px 0" }}>
            {[
              ...
              <div key={logo.alt} style={{ display: "flex", alignItems: "center", justifyContent: "center", height: 72, background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 8, padding: "10px 20px" }}>
                <img src={logo.src} alt={logo.alt} style={{ maxHeight: 48, maxWidth: "85%", objectFit: "contain", opacity: 0.7, filter: "brightness(0) invert(1)" }} />
              </div>
            ))}
          </div>
        </div>
